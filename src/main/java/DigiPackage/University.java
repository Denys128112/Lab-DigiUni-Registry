...
public class University {
    ...
    public void setFullName(String fullName) {
        ...
        else throw new ValidatingException("Full name cannot be empty");
    }

    public String getShortName() { return shortName; }
    public void setShortName(String shortName) {
        if (shortName != null && !shortName.trim().isEmpty()) this.shortName = shortName;
        else throw new ValidatingException("Short name cannot be empty");
    }

    public String getCity() { return city; }
    public void setCity(String city) {
        if (city != null && !city.trim().isEmpty()) this.city = city;
        else throw new ValidatingException("City cannot be empty");
    }

    public String getAddress() { return address; }
    public void setAddress(String address) {
        if (address != null && !address.trim().isEmpty()) this.address = address;
        else throw new ValidatingException("Address cannot be empty");
    }
